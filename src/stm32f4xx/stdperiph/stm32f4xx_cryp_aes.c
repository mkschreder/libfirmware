                         ...
                         uint8_t *AuthTAG, uint32_t TAGSize)
{
  ...
  if(headersize != 0)
  {
    ...
    else
    {
      ...
      HBuffer[bufferidx++] = (uint8_t)(headersize >> 24);
      HBuffer[bufferidx++] = (uint8_t)(headersize >> 16);
      HBuffer[bufferidx++] = (uint8_t)(headersize >> 8);
      HBuffer[bufferidx++] = (uint8_t)(headersize);
      headersize += 6;
    }
  ...
  /* Flags byte */
  blockb0[0] = (uint8_t)
  	(blockb0[0] | (uint8_t)(((( (uint8_t) TAGSize - 2) / 2) & 0x07 ) << 3 ) | (uint8_t)( ( (uint8_t) (15 - NonceSize) - 1) & 0x07));
