...
#define _ToggleDTOG_RX(bEpNum)    (_SetENDPOINT(bEpNum, \
                                   (uint16_t)(EP_CTR_RX|EP_CTR_TX|EP_DTOG_RX | (_GetENDPOINT(bEpNum) & (uint16_t)EPREG_MASK))))
#define _ToggleDTOG_TX(bEpNum)    (_SetENDPOINT(bEpNum, \
                                   (uint16_t)(EP_CTR_RX|EP_CTR_TX|EP_DTOG_TX | (_GetENDPOINT(bEpNum) & (uint16_t)EPREG_MASK))))
...
#define _SetEPAddress(bEpNum,bAddr) _SetENDPOINT(bEpNum,\
    (uint32_t)(EP_CTR_RX|EP_CTR_TX|(_GetENDPOINT(bEpNum) & (uint32_t)EPREG_MASK)) | (uint32_t)bAddr)
...
* Return         : None.
*******************************************************************************/
#define _SetEPTxAddr(bEpNum,wAddr) (*_pEPTxAddr(bEpNum) = ((uint32_t)((wAddr >> 1) << 1)))
#define _SetEPRxAddr(bEpNum,wAddr) (*_pEPRxAddr(bEpNum) = ((uint32_t)((wAddr >> 1) << 1)))
