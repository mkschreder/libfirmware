...
#define TIM2_TIM8_TRGO                     (0x0000)
#define TIM2_ETH_PTP                       (0x0400)
#define TIM2_USBFS_SOF                     (0x0800)
#define TIM2_USBHS_SOF                     (0x0C00)

#define TIM5_GPIO                          (0x0000)
#define TIM5_LSI                           (0x0040)
#define TIM5_LSE                           (0x0080)
#define TIM5_RTC                           (0x00C0)

#define TIM11_GPIO                         (0x0000)
#define TIM11_HSE                          (0x0002)
